...
class TestCasePositive:
    ...
    def test_crud_users(self, db_conn):
        ...
        # updated value 'email'
        update_info_for_user = {'name': 'Oleksandr', 'email': 'oleksandr@gmail.com',
        ...
        db_conn.update_user(update_info_for_user, user_id)
        assert db_conn.read_user_info(user_id) == (
    ...
    def test_crud_cart(self, db_conn):
        ...
        update_info_for_cart = {'creation_time': '2021-02-04 11:20:00', 'user_id': user_id}

        # creating cart
        db_conn.create_cart(new_cart, cart_details)
        ...
        db_conn.update_cart(update_info_for_cart, cart_id)
...
class TestCaseNegative:
    ...
    def test_crud_users(self, db_conn):
        ...
        pytest.raises(psycopg2.Error, lambda: db_conn.update_user(update_info_for_user, 2))
    ...
    def test_crud_cart(self, db_conn):
        ...
        new_cart = {'creation_time': '2021-02-04 11:20:00', 'user_id': not_exist_user_id}
        cart_details = [{'price': 1000, 'product': 'Iphone'},
                        {'price': 2000, 'product': 'Macbook'}]
        update_info_for_cart = {'creation_time': '2021-02-04 11:20:00', 'user_id': not_exist_user_id}

        # creating cart on not existing user_id
        pytest.raises(psycopg2.Error, lambda: db_conn.create_cart(new_cart, cart_details))
        ...
        pytest.raises(psycopg2.Error, lambda: db_conn.update_cart(update_info_for_cart, 1))
