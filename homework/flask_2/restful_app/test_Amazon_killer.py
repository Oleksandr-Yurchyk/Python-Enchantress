...
from homework.flask_2.restful_app.Amazon_killer_main import amazon_killer as app
...
def test_create_user(store_app):
    # Create user
    data_to_create_user = {"name": "Ilia", "email": "illia.sukonnik@gmail.com", }
...
def test_update_user(store_app):
    data_to_update = {"name": "Ilia", "email": "illia.sukonnik@example.com", }
